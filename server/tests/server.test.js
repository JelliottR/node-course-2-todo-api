const expect = require('expect'), request = require('supertest');
...
describe('PATCH /todos/:id', () => {
    ...
    it('should clear completedAt when todo is not completed', (done) => {
        ...
        const body = {
            text: "Updated text from test for a second time",
            completed: false
        };
